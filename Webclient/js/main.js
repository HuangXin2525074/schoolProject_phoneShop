(function($) {
	...
	// Menu.
		$('#menu')
			.append('<a href="#menu" class="close-toggle"></a>')
			.appendTo($body)
			.panel({
				delay: 500,
				hideOnClick: true,
			 ...
			 $('#registrationsModal').on('click', function() {
			 	$('#registrationModal').show();
			 	$('#registrationModal').css("opacity",1);
			 });
			 $('.closeRegisterModal').on('click', function() {
			 	$('#registrationModal').hide();
			 	$('#registrationModal').css("opacity",0);
			 });
			 $('#searchModal').on('click', function() {
			 	$('#searchBatch').show();
			 	$('#searchBatch').css("opacity", 1);
			 });
			 $('#closeSearchModal').on('click', function() {
			 	$('#searchBatch').hide();
			 	$('#searchBatch').css("opacity",0);
			 });
...
function myRegister() {
	...
	// Get the value of input field with id
